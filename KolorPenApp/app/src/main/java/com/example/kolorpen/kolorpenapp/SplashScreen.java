...
//            hide();
            //
            Intent intent;
            String macAddress = sharedPref.getString(getString(R.string.uniqueMacAddress), "");
...
//        sharedPref = SplashScreen.this.getPreferences(getApplicationContext().MODE_PRIVATE);
